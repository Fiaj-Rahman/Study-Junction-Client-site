...
const UpdatePage = () => {
    ...
    const handleFormCreate = async(e) =>{
        ...
        try{
            const{data} = await axios.put(`https://assignment11-server-site-peach.vercel.app/assignment/${assignment._id}`,updateAssignmentData)
            // console.log(data)
            toast.success('Successfully Update a assignment...')
          ...
          <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
            ...
            <div className="col-span-full sm:col-span-2">
              ...
              <select
                className="w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300 p-2"
                name="difficulty"
                defaultValue={assignment.difficulty_level}
                id="cars"
              >
